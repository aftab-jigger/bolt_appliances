...
const categories = [
  {
    id: 1,
    name: "Dryer",
    description: "Energy-efficient dryers for quick drying",
    icon: (
      <svg viewBox="0 0 100 100" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="35" cy="24" r="3" fill="#0891b2" />
        <circle cx="50" cy="24" r="3" fill="#0891b2" />
        <circle cx="65" cy="24" r="3" fill="#0891b2" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 100 100" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="45" cy="20" r="3" fill="#0891b2" />
        <rect x="25" y="32" width="50" height="50" rx="4" fill="#cffafe" stroke="#0891b2" strokeWidth="1.5" />
        <ellipse cx="50" cy="45" rx="18" ry="8" fill="#a5f3fc" />
        <ellipse cx="50" cy="65" rx="15" ry="6" fill="#a5f3fc" />
        <line x1="35" y1="45" x2="65" y2="45" stroke="#0891b2" strokeWidth="1" />
        <line x1="38" y1="55" x2="62" y2="55" stroke="#0891b2" strokeWidth="1" />
        <line x1="40" y1="65" x2="60" y2="65" stroke="#0891b2" strokeWidth="1" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 100 100" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="70" y="15" width="4" height="12" rx="2" fill="#0891b2" />
        <rect x="70" y="45" width="4" height="20" rx="2" fill="#0891b2" />
        ...
        <circle cx="35" cy="80" r="4" fill="#67e8f9" />
        <circle cx="50" cy="80" r="4" fill="#67e8f9" />
        <circle cx="65" cy="80" r="4" fill="#67e8f9" />
      </svg>
    ),
  },
  {
    id: 4,
    name: "Microwave Oven",
    description: "Quick and convenient cooking",
    icon: (
      <svg viewBox="0 0 100 100" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="75" cy="48" r="4" fill="#0891b2" />
  ...
  },
  {
    id: 5,
    name: "Cooker",
    description: "Professional cooking at home",
    icon: (
      <svg viewBox="0 0 100 100" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="35" cy="37" r="5" fill="#0891b2" />
        <circle cx="50" cy="37" r="5" fill="#0891b2" />
        <circle cx="65" cy="37" r="5" fill="#0891b2" />
        ...
        <circle cx="35" cy="10" r="3" fill="#f97316" />
        <circle cx="50" cy="6" r="3" fill="#f97316" />
        <circle cx="65" cy="10" r="3" fill="#f97316" />
      </svg>
    ),
  },
  {
    id: 6,
    name: "Hobs",
    description: "Precision heat control for cooking",
    icon: (
      <svg viewBox="0 0 100 100" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="32" cy="47" r="8" fill="#0f172a" stroke="#f97316" strokeWidth="1.5" />
        <circle cx="32" cy="47" r="4" fill="#fbbf24" />
        <circle cx="68" cy="47" r="12" fill="#0f172a" stroke="#ef4444" strokeWidth="2" />
        <circle cx="68" cy="47" r="8" fill="#0f172a" stroke="#f97316" strokeWidth="1.5" />
        <circle cx="68" cy="47" r="4" fill="#fbbf24" />
        <circle cx="32" cy="68" r="6" fill="#0f172a" stroke="#64748b" strokeWidth="1.5" />
        <circle cx="68" cy="68" r="6" fill="#0f172a" stroke="#64748b" strokeWidth="1.5" />
