...
const slides = [
  {
    ...
    description: "Discover our range of energy-efficient smart refrigerators with advanced cooling technology.",
    image: "../../src/assets/illustrationIamges/modern-smart-refrigerator-kitchen-illustration.jpg",
  ...
  
  {
    ...
    description: "Beat the heat with our energy-saving air conditioners featuring smart climate control.",
    image: "/modern-air-conditioner-living-room-illustration.jpg",
    cta: "Shop ACs",
  },
  {
    id: 4,
    ...
    description: "Elevate your cooking experience with our premium microwave ovens and kitchen essentials.",
    image: "/modern-kitchen-appliances-microwave-oven-illustrat.jpg",
    cta: "Shop Kitchen",
  },
]
        ...
        {slides.map((_, index) => (
          <button
            ...
            className={`h-2 rounded-full transition-all duration-1000 ${
              index === currentSlide ? "w-20 bg-teal-500" : "w-2 bg-white/50 hover:bg-white/80"
            }`}
