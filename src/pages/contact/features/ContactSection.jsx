...
import { Phone, Mail, MapPin, Building2, Send, Clock } from "@/assets/icons/icons"
...
const ContactSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="py-8 md:py-8 bg-gradient-to-b from-background to-teal-50/30 relative overflow-hidden"
    >
